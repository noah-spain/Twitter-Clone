...
document.addEventListener('click', function(e){
    if(e.target.dataset.like){
       handleLikeClick(e.target.dataset.like) 
        ...
        myReply(e.target.dataset.replybtn)
    }
...
function myReply(tweetId){
    const textArea = document.querySelector(`[data-replytext="${tweetId}"]`)
...
<div class="tweet">
        ...
        <div>
            ...
            <div class="tweet-details">
                ...
                <span class="tweet-detail">
                 ...
                 <span class="tweet-detail">
                 <i class="fa-duotone fa-solid fa-xmark"  data-deletetweet="${tweet.uuid}"></i>
                </span>
    ...
    <div class="hidden" id="replies-${tweet.uuid}">
        ${repliesHtml}
        <textarea placeholder="Reply?" data-replytext="${tweet.uuid}"></textarea>
